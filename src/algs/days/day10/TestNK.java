...
// converted this into a straight up java code to avoid JUnit issues...
public class TestNK {
	...
	private void assertTrue(boolean contains) {
		if (contains != true) { throw new RuntimeException("Assertion doesn't pass"); }
	}

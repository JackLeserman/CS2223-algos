...
// % java algs.days.day24.DijkstraSP day25.txt 
public class DijkstraSP {
	...
	public static void main(String[] args) {
		...
		// inclass example
		AbstractWeightedDigraph sample = new DigraphAdjacencyList(new In(new File ("day25.txt")));
